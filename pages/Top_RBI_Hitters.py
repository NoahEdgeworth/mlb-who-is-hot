...
hr_leaders = eligable_avg_leaders.sort_values(by='RBI', ascending=False)
hr_leaders = hr_leaders[['Name', 'Age', 'Tm', 'RBI', 'PA']]
st.write(hr_leaders.head(5))
st.write(bar_chart(hr_leaders.head(5), 'RBI', 'Top 5 RBI Hitters this month'))